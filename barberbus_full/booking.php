...
$services = $pdo->query("SELECT * FROM services WHERE is_active = TRUE ORDER BY id ASC")->fetchAll();
$barbers = $pdo->query("SELECT * FROM barbers WHERE is_active = TRUE ORDER BY id ASC")->fetchAll();
